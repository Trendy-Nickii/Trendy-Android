...
import com.kh.ite.rupp.edu.trendy.databinding.CartCheckoutItemLayoutBinding
import com.squareup.picasso.Picasso

class CheckoutCartItemViewHolder(itemView: View, private val context: Context): RecyclerView.ViewHolder(itemView) {
    private val binding: CartCheckoutItemLayoutBinding = CartCheckoutItemLayoutBinding.bind(itemView)

    fun onBin(
        item: CartCheckoutSummaryModel.OrderDetails.Item,
        position: Int
    ){
        try{
    ...
    private fun initPriceDisplay(item : CartCheckoutSummaryModel.OrderDetails.Item){
